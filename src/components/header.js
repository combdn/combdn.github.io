...
export default function Header() {
  return (
    <div className="header__intro">
      <p>
        Hi, I'm Valery. I’m obsessed with software user interfaces. (I literally
        have 321 items in my “Applications” folder right now.)
      </p>
      <p>
        ...
        . I’ve only managed to write <Link to="/case/pw">one case</Link> so far…
